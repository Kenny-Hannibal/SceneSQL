...
|------|------|------|------|------|
| `link_id` | TEXT | ✓ | 🔑 |  |
| `link_type` | TEXT | ✓ |  | 枚举 20 个值（见下方） |
| `link_turn_type` | TEXT | ✓ |  | 枚举 19 个值（见下方） |
| `link_class` | TEXT | ✓ |  | 枚举 12 个值（见下方） |
| `link_attribute` | TEXT | ✓ |  | 枚举 9 个值（见下方） |
...
| `lane_type` | TEXT | ✓ |  | 枚举 11 个值（见下方） |
| `lane_turn_type` | TEXT | ✓ |  | 枚举 18 个值（见下方） |
