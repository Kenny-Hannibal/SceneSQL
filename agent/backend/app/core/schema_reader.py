...
FIELD_SEMANTICS = {
    ...
    "ego": {
        ...
        "ego_link_id": "自车所在道路link序号（小整数1,2,3...，不是static_link.link_id！JOIN static_link必须用ego_static_map_link_id）",
        "ego_static_map_link_id": "静态地图中的link ID（大整数，JOIN static_link.link_id的键。需CAST为TEXT匹配。=-1表示无匹配link）",
