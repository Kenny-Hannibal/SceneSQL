...
_MANUAL_KEYWORD_OVERRIDES: Dict[str, List[str]] = {
    ...
    "TrafficIntersection": ["红绿灯路口", "信号灯路口"],
    "RunRedLight": ["闯红灯"],
    "CrossStopLineOnYellowLight": ["黄灯过线", "抢黄灯"],
    "GreenLightNotProceeding": ["绿灯不走", "绿灯未起步"],
    "TrafficLightAbnormal": ["红绿灯异常", "信号灯异常"],
    "CrossVRUV1": ["行人横穿", "VRU横穿", "骑行者横穿"],
    "CrossVehicle": ["车辆横穿", "侧方来车"],
    "LowTTC": ["碰撞风险", "TTC低", "即将碰撞"],
    "ObstacleCollision": ["碰撞", "撞障碍物"],
    "ObstacleNearMiss": ["近碰", "险碰", "差点撞"],
    "LaneKeep": ["直行", "保持车道", "车道保持"],
    "LaneMerging": ["车道合并", "合流"],
    "OnRamp": ["上匝道", "进匝道"],
    "OffRamp": ["下匝道", "出匝道"],
    "Roundabout": ["环岛", "转盘"],
    ...
    "SteeringSmallSwing": ["方向盘抖动", "方向盘摆动"],
    "HighSteeringWheelTorque": ["方向盘力矩大"],
    "Turning": ["转向", "左转", "右转", "掉头"],
