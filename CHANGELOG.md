...
| 日期 | 标题 | 文件 |
|------|------|------|
| 2026-09-02 | 交接包环境解耦：facts 原环境快照免责标注 + AGENTS.md 部署节改接手人视角 + 交接手册入库 | `changelog/2026-09-02_交接包环境解耦-facts免责标注-AGENTS部署节改接手人视角-交接手册入库.md` |
| 2026-08-25 | 循环迭代 6 项：路由决策日志 / hybrid 截断防护 / 枚举精选 / 大结果集保护 / CRA→Vite / 多用户隔离 v1 | `changelog/2026-08-25_循环迭代-可观测性-Vite迁移-多用户隔离等6项.md` |
| 2026-08-25 | rg-17 聚合查询非可视化结果类型 + 自修改流②③⑤工具层（复测 26/26） | `changelog/2026-08-25_rg17聚合非可视化结果类型-自修改流工具层.md` |
| 2026-08-25 | NL2SQL 自修改流地基 + 路由健壮性 6 项（回归评测 24/25 / 否定护栏 / 策略启停 / LLM 降级 / resolve 持久化 / 阈值校准） | `changelog/2026-08-25_NL2SQL自修改流地基-回归评测-否定护栏-策略启停等6项.md` |
| 2026-08-20 | 向量路由索引质量增强：口语化同义词表（hit@1 55%→90%，hit@3 65%→100%） | `changelog/2026-08-20_向量路由索引质量增强-口语化同义词表.md` |
